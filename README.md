...
3. Adjust the master_preproc.sh script such that it has the proper pathnames to your raw data and output directory.

4. Open a terminal, cd into the STISuite folder and run the following command:
